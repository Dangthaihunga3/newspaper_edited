...
class Article(object):
    ...
    def download(self, input_html=None, title=None, recursion_counter=0):
        ...
        html = html.replace('data-src=', 'src=') #added more
        # html = html.replace('loading="lazy"', '') #added more
        # html = html.replace('class="lazyload"', '') #added more
        # html = html.replace('class="lazy"', '') #added more
        self.set_html(html)
